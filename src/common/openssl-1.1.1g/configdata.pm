...
our %config = (
  AR => "/media/alex/ex-hard/oct/gcc-linaro-arm-linux-gnueabihf-4.7-2013.03-20130313_linux/bin/arm-linux-gnueabihf-ar",
  ARFLAGS => [ "r" ],
  ...
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CXX => "/media/alex/ex-hard/oct/gcc-linaro-arm-linux-gnueabihf-4.7-2013.03-20130313_linux/bin/arm-linux-gnueabihf-g++",
  CXXFLAGS => [ "-Wall -O3" ],
  ...
  LDLIBS => [  ],
  PERL => "/usr/bin/perl",
  RANLIB => "/media/alex/ex-hard/oct/gcc-linaro-arm-linux-gnueabihf-4.7-2013.03-20130313_linux/bin/arm-linux-gnueabihf-ranlib",
  RC => "windres",
  RCFLAGS => [  ],
  afalgeng => "",
  b32 => "1",
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)/media/alex/ex-hard/oct/gcc-linaro-arm-linux-gnueabihf-4.7-2013.03-20130313_linux/bin/arm-linux-gnueabihf-gcc",
  minor => "1.1",
  ...
  openssldir => "",
  options => "enable-shared -DL_ENDIAN --prefix=/media/alex/abd36268-599a-4aa3-8170-01f346fdf216/tlsq/kdcu/tlsq-kdcu/src/common/openssl-1.1.1g/build-kdcu no-asan no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "i686-linux-gnu-thread-multi-64int",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.18.2",
  perlargv => [ "linux-generic32", "shared", "-DL_ENDIAN", "CC=/media/alex/ex-hard/oct/gcc-linaro-arm-linux-gnueabihf-4.7-2013.03-20130313_linux/bin/arm-linux-gnueabihf-gcc", "CXX=/media/alex/ex-hard/oct/gcc-linaro-arm-linux-gnueabihf-4.7-2013.03-20130313_linux/bin/arm-linux-gnueabihf-g++", "NM=/media/alex/ex-hard/oct/gcc-linaro-arm-linux-gnueabihf-4.7-2013.03-20130313_linux/bin/arm-linux-gnueabihf-nm", "AR=/media/alex/ex-hard/oct/gcc-linaro-arm-linux-gnueabihf-4.7-2013.03-20130313_linux/bin/arm-linux-gnueabihf-ar", "RANLIB=/media/alex/ex-hard/oct/gcc-linaro-arm-linux-gnueabihf-4.7-2013.03-20130313_linux/bin/arm-linux-gnueabihf-ranlib", "LD=/media/alex/ex-hard/oct/gcc-linaro-arm-linux-gnueabihf-4.7-2013.03-20130313_linux/bin/arm-linux-gnueabihf-ld", "--prefix=/media/alex/abd36268-599a-4aa3-8170-01f346fdf216/tlsq/kdcu/tlsq-kdcu/src/common/openssl-1.1.1g/build-kdcu" ],
  perlenv => {
      "AR" => undef,
      "BUILDFILE" => undef,
      "CC" => undef,
  ...
  prefix => "/media/alex/abd36268-599a-4aa3-8170-01f346fdf216/tlsq/kdcu/tlsq-kdcu/src/common/openssl-1.1.1g/build-kdcu",
  processor => "",
